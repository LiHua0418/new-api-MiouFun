...
func Recharge(referenceId string, customerId string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		affRebate, err = GrantAffRechargeRebateWithTx(tx, topUp.UserId, quotaToAdd)
		if err != nil {
			return err
		}
	...
	RecordAffRechargeRebateLog(affRebate, "Stripe")
...
func ManualCompleteTopUp(tradeNo string, callerIp string) error {
	...
	RecordAffRechargeRebateLog(affRebate, "管理员补单")
	return nil
}
func RechargeCreem(referenceId string, customerEmail string, customerName string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		affRebate, err = GrantAffRechargeRebateWithTx(tx, topUp.UserId, int(quota))
		if err != nil {
			return err
		}
	...
	RecordAffRechargeRebateLog(affRebate, "Creem")
...
func RechargeWaffo(tradeNo string, callerIp string) (err error) {
	...
	if quotaToAdd > 0 {
		...
		RecordAffRechargeRebateLog(affRebate, "Waffo")
	}
...
func RechargeWaffoPancake(tradeNo string) (err error) {
	...
	if quotaToAdd > 0 {
		...
		RecordAffRechargeRebateLog(affRebate, "Waffo Pancake")
	}
